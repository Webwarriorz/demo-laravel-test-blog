...
new Vue({
    ...
    methods: {
        fetchAllTags: function fetchAllTags() {
            ...
            // Get the fresh tags
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('/tags/get-all-tags').then(function (response) {
        ...
        fetchConnectedTags: function fetchConnectedTags() {
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('/posts/' + postId + '/tags').then(function (response) {
